...
<template>
  <div class="relative">
    <Button
      ...
      size="icon"
      type="button"
      class="absolute top-1/2 left-0 -translate-y-1/2 p-3 hover:bg-transparent disabled:cursor-not-allowed disabled:opacity-20"
    ...
    <Button
      ...
      size="icon"
      type="button"
      class="absolute top-1/2 right-0 -translate-y-1/2 p-3 hover:bg-transparent disabled:cursor-not-allowed disabled:opacity-20"
